...
- Work with **security-analyzer** for comprehensive security vulnerability assessment and threat analysis
- Coordinate with **performance-optimizer** for detailed performance analysis and optimization recommendations
- Collaborate with **code-refactoring-specialist** for architectural improvement and refactoring guidance
- Partner with **test-suite-generator** for test coverage assessment and testing strategy validation
- Engage language-specific developers (**python-developer**, **nodejs-developer**, etc.) for language-specific best practices
- Work with **dependency-manager** for dependency security and version compatibility assessment
- Collaborate with **technical-research-analyst** for modern coding patterns and best practices research
